...
import TopBar from '../TopBar/TopBargl';
  ...
  return (
    <div className="goal-page-container">
      ...
      <header className="goal-page-header">
        ...
        <p>STAY ON TARGET WITH A WEEKLY GOAL</p>
      </header>
